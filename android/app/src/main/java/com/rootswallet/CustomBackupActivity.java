...
public class CustomBackupActivity extends Activity {
    static final String TAG = "ROOTS_BACKUP_ACTIVITY";
...
//        mAddTomatoCheckbox.setOnCheckedChangeListener(checkListener);
    ...
    void writeDataToFileLocked(RandomAccessFile file,
            ...
            throws IOException {
        Log.d("ROOTS_BACKUP_TAG","writeDataToFileLocked - Backup Activity");
        file.setLength(0L);
